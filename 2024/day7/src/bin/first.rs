...
impl Equation {
    fn solvable(&self) -> bool {
        ...
        repeat_n(
            [Operation::Add, Operation::Multiply].into_iter(),
...
" => 3749)]
    ...
    #[test_case("156: 15 6" => false ; "second unsolvable example")]
    #[test_case("7290: 6 8 6 15" => false ; "third unsolvable example")]
    #[test_case("161011: 16 10 13" => false ; "fourth unsolvable example")]
    #[test_case("192: 17 8 14" => false ; "fifth unsolvable example")]
    #[test_case("21037: 9 7 18 13" => false ; "sixth unsolvable example")]
